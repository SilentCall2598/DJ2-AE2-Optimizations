...
public final class Phase2MatcherTest {
    ...
    static void basicLifecycle() {
        ...
        Phase2MatcherContext.recordMatcherCall(true);
        Phase2MatcherContext.recordMatcherCall(false);
        Phase2MatcherContext.recordMatcherCall(true);
        ...
        check("three matcher calls recorded", Diagnostics.phase2MatcherCallsTotal == callsBefore + 3,
    ...
    static void extraExitIsSafe() {
        check("an exit with nothing entered is a no-op", true, "");
        Phase2MatcherContext.exit();
        Phase2MatcherContext.exit();
        check("inactive after extra exits", !Phase2MatcherContext.active(), "expected inactive");
    }
